    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start gap-2">
          ...
          <Arrow active={step === 1} color={COLORS.yellow} />
          ...
          <Arrow active={step === 2} color={COLORS.purpleLight} />
          ...
          <Arrow active={step === 2} color={COLORS.blue} />
      ...
      {/* Key insight */}
      <div className="px-6 pb-3 text-xs text-center">
